...
class JurisSummarizer:
    ...
    def __init__(self):
        ...
        self.prompt = ChatPromptTemplate.from_messages([
            ("system", "Tu es un expert en droit béninois. Ta mission est de résumer une jurisprudence de manière concise et factuelle, sans inventer de détails (pas d'hallucination)."),
